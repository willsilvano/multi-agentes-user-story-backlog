...
COMMENT ON COLUMN pipeline_runs.agente_03_resultado IS 'JSON com: scores (completude, consistencia, cobertura_riscos, testabilidade, score_geral), gaps, sugestoes, relatorio';
